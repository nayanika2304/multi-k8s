...
docker build -t nayanika2304/multi-client:latest -t nayanika2304/multi-client:$SHA -f ./client/Dockerfile ./client
docker build -t nayanika2304/multi-server:latest -t nayanika2304/multi-server:$SHA -f ./server/Dockerfile ./server
docker build -t nayanika2304/multi-worker:latest -t nayanika2304/multi-worker:$SHA -f ./worker/Dockerfile ./worker
